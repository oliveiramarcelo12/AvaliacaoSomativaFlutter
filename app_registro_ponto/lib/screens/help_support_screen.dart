          ...
          content: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Text('  - Para assistência, entre em contato com o suporte via email: suporte@registroponto.com'),
                Text('  - Ou pelo telefone: (19) 98721-0185'),
              ],
            ),
          ),
          actions: [
        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 20),
              Text(
                'Email: suporte@registroponto.com',
                style: TextStyle(fontSize: 16, color: Colors.white),
                textAlign: TextAlign.center,
              ),
              SizedBox(height: 10),
              Text(
                'Telefone: (19) 98721-0185',
                style: TextStyle(fontSize: 16, color: Colors.white),
                textAlign: TextAlign.center,
              ),
              SizedBox(height: 40),
